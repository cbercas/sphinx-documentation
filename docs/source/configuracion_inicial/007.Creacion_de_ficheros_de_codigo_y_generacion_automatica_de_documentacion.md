...
-   `math_operations.rst` o `math_operations.md`
...
### 2. **Contenido de los Archivos Generados**
...
El archivo `math_operations.md` generado tendrá algo similar a esto:
...
### 4. **Personalización de la Documentación Generada**
